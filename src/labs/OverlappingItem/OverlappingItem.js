...
const OverlappingItem = ({ index, item, children, className, ...restProps }) => {
  const { clippingIndex, activeIndex, translateIndex, fromLeft, fromRight } = useContext(OverlappingContext)
